...
import { announcementEntityPermissions } from '@internal/plugin-picpay-announcements-common';
...
export const AnnouncementsCard = ({
  ...
  if (+(announcements?.count ?? 0) <= 0 && !flags.admin_announcements) {
    return (
      <InfoCard
        title={title ? title : 'Announcements'}
        variant="gridItem"
        deepLink={deepLink}
      >
