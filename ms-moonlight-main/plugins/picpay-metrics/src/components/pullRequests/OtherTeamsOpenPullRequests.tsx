...
type OtherTeamsOpenPullRequestsProps = {
  data: PullRequestDetails[];
};

export const OtherTeamsOpenPullRequests: React.FC<OtherTeamsOpenPullRequestsProps> = ({ data }) => {
    ...
    <Grid container>
      <Grid item lg>
        <Table<PullRequestDetails>
          ...
          data={data}
          title="Pull Requests Opened by Other Teams"
          columns={[
            {
              title: 'TITLE',
